...
// - Display all the names of people objects (case-insensitive) that have the same name; return an array of strings with the names that are the same.

// Initiate code:

// // XXXXX is your code let people = [
